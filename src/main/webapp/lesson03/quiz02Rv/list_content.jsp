...
<section class="contents">
	<%--아티스트 정보영역--%>
	<div class="singer-info d-flex mt-4 border border-4 border-success p-3">
	...
	<div class="music-list">
		<h4 class="mt-3 mb-3 font-weight-bold">곡 목록</h4>
		<table class="table text-center">
			...
			<tbody>
				...
				<tr>
					<td><%=item.get("id")%></td>
					<%--TODO:::::: href 링크 채워주기 --%>
					<td><a href="quiz02Rv_info_template.jsp?id=<%=item.get("id")%>"><%=item.get("title")%></a></td>
